...
public class ViewConstructionJobDemand extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_view_construction_job_demand2);

        ArrayList data = JobDemandActivity.databaseManager.getData("construction");
