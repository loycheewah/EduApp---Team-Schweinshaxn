...
public class ViewOthersJobDemand extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_view_others_job_demand);

        ArrayList data = JobDemandActivity.databaseManager.getData("others");
